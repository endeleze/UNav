...
class AutoScrollbar(ttk.Scrollbar):
    """
    A scrollbar that hides itself when not needed. Works only with grid geometry manager.

    Usage:
        from ui_helpers import AutoScrollbar
        hbar = AutoScrollbar(parent, orient='horizontal')
        vbar = AutoScrollbar(parent, orient='vertical')
    """
    def set(self, lo, hi):
        # Hide scrollbar if full range
